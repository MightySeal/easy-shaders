 ...
 */
package io.shaderfoundry.lib.opengl
...
import io.shaderfoundry.lib.util.InputFormat
import io.shaderfoundry.lib.util.OutputSurface
import io.shaderfoundry.lib.util.is10BitHdrBackport
...
internal class OpenGlRenderer {
    ...
    private fun createOutputSurfaceInternal(surface: Surface): OutputSurface? {
        ...
        return OutputSurface.Companion.of(eglSurface, size.width, size.height)
    }
