...
internal class UnsafeProgramPipeline: ProgramPipeline {
    ...
    init {
        ...
        GLUtils.checkGlErrorOrThrow("glGenProgramPipelines")
        ...
        GLUtils.checkGlErrorOrThrow("glUseProgramStages vertex")
        GLES31.glUseProgramStages(pipelineId, GLES31.GL_FRAGMENT_SHADER_BIT, fragmentShader.shaderProgramId.handle)
        GLUtils.checkGlErrorOrThrow("glUseProgramStages fragment")
    ...
    override fun setFragmentShader(shader: FragmentShader) {
        ...
        GLUtils.checkGlErrorOrThrow("newShader glUseProgramStages")
        fragmentShader.use()
        GLUtils.checkGlErrorOrThrow("newShader useInternal")
